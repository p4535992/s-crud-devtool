...
<!-- FormValidation -->	
<script src="<%=appPath %>/assets/vendor/formvalidation/formValidation.min.js"></script>
<script src="<%=appPath %>/assets/vendor/formvalidation/formvalidation_bootstrap.min.js"></script>
<script>
