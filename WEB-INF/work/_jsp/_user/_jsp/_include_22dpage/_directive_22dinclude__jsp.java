...
public class _directive_22dinclude__jsp extends com.caucho.jsp.JavaPage
{
 ...
 String bConfigSMS = request.getParameter("ConfigSMS") ; 
    ...
    if(bConfigSMS.equalsIgnoreCase("true")){
    out.write(' ');
    out.print((WebApp ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("user/jsp/include-page/directive-include.jsp"), -2555645190472214545L, false);
    _caucho_depends.add(depend);
