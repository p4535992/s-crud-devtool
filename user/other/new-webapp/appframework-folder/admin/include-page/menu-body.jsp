...
{
%>
  <jsp:include page ="/admin/include-page/assets/topbar/menu-body-topbar.jsp">
...
{
%>
  <jsp:include page ="/admin/include-page/assets/center/menu-body-center.jsp">
		 <jsp:param  name="MenuTitle" value="<%=MenuTitle %>"/>
		 <jsp:param  name="MenuLink" value="<%=MenuLink %>"/>
	</jsp:include>	
<%  
...
{
%>
  <jsp:include page ="/admin/include-page/assets/base/menu-body-base.jsp">
		 <jsp:param  name="MenuTitle" value="<%=MenuTitle %>"/>
		 <jsp:param  name="MenuLink" value="<%=MenuLink %>"/>
	</jsp:include>	
<%  
