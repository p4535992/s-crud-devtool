...
if(SiMngrBn.locateRecord(LogUsr.AdminID))
{
	SiMngrBn.LoginStatus = com.$WEBAPP.LoginStatusFlag.NOT_LOGGED ;
...
{
  LogUsr.invalidate();
  session.removeAttribute("theSitemanager") ;
	session.invalidate() ;
}
        ...
        <div class="panel-body">
          ...
          <div class="brand">
            ...
            <h2 class="brand-text font-size-18 text-uppercase"><%=ApplicationResource.ProductName %></h2>
					 ...
					 <h3><%=ShowItem.showAdminName(LogUsr.AdminID, 3) %></h3>
           logged out  from current browser session
                  ...
                  <div class="col-sm-6">
									<a href="<%=appPath %>/AdminLoginForm.jsp">
                    <div class="example">
                      <div class="ribbon ribbon-clip ribbon-primary">
