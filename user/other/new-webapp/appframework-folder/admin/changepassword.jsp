...
String NewPassword1 = request.getParameter("NewPassword1");
          ...
          if(Password.equals(SiMngrBn.Password))
	        {
	             SiMngrBn.Password= NewPassword1;
                    ...
                    <div class="form-group">
                      <div class="col-sm-7 col-sm-offset-5">
                        <button type="submit" class="btn btn-primary"><i class="icon fa fa-check" aria-hidden="true"></i>&nbsp;Update</button>
												<button type="button" class="btn btn-default btn-outline" onclick="NavigateTo('<%=appPath %>/admin/index.jsp')"><i class="fa fa-remove" aria-hidden="true"></i>&nbsp;Cancel</button>
                      </div>
                    </div>
    </form>
...
<a class="btn btn-icon btn-primary btn-round btn-block btn-lg" href="<%=appPath %>/admin/index.jsp" data-toggle="tooltip" data-placement="auto bottom" title="Home"><i class="fa fa-home fa-lg" aria-hidden="true"></i>&nbsp;Home</a>
