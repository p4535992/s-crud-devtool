...
<div class="panel-body panel-form-box-body container-fluid">	
      ...
      <div class="form-group">
        <label for="MobileNumber" class="col-md-3 col-sm-4 col-xs-12 control-label blue-grey-600">Mobile No. :</label>
        <div class="col-md-6 col-sm-6 col-xs-12"><input type="text" name="MobileNumber" id="MobileNumber" class="form-control" value="<%=StrValue(Mobile) %>" /><span class="help-block"><%=SetSms.getValidNumberAdvice() %></span></div>
      </div>	
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
				  <textarea rows="3" cols="40" name="SMSText" id="SMSText" class="form-control" data-plugin="maxlength" maxlength="<%=sms_charater_limit %>" ><%=StrValue(Message) %></textarea>
				</div>
      </div>	
