...
import  javax.sql.* ;	
/*
   Code generated on : 30/06/2016 06:34 PM
...
public void copyTo(com.db.$DATABASE.MasteritemtableBean other )
{
...
public void copyFrom(com.db.$DATABASE.MasteritemtableBean other )
{
...
ColumnName = rslt.getString("ColumnName"); 
...
throws java.sql.SQLException 
{
 ...
 try{
    String query_add = " INSERT INTO `masteritemtable` ( `RecordID`, `Attribute`, `TableName`, `ColumnName`, `UpdateDateTime` ) VALUES ( ?, ?, ?, ?, ?  ) ";
 ...
 throws java.sql.SQLException 
{
  ...
  String query_insert = " INSERT INTO `masteritemtable` ( `RecordID`, `Attribute`, `TableName`, `ColumnName`, `UpdateDateTime` ) VALUES ( ?, ?, ?, ?, ?  ) ";
	...
	throws java.sql.SQLException 
{
  ...
  try
	  {
    String query_update = " UPDATE `masteritemtable` SET `RecordID` = ?, `Attribute` = ?, `TableName` = ?, `ColumnName` = ?, `UpdateDateTime` = ?  WHERE `masteritemtable`.`RecordID` = "+update_RecordID+" " ;
...
throws java.sql.SQLException 
{
 ...
 if(conn==null) return false ;
 try{
    String query_del = "  DELETE FROM `masteritemtable` WHERE `masteritemtable`.`RecordID` = "+delete_RecordID+" " ;
...
throws java.sql.SQLException 
{
 ...
 if(conn==null)return false;
 try{
    String query_locate = "  SELECT *  FROM `masteritemtable` WHERE  `masteritemtable`.`RecordID` = "+locate_RecordID+" " ;
...
throws java.sql.SQLException 
{
   ...
   try
	 {
    String query_locate_on_field = "  SELECT * FROM `masteritemtable`  WHERE `"+field+"` = '"+value+"' " ;
...
/* General purpose table opening method  */	
  ...
  throws java.sql.SQLException
  {
      ...
      _query =   "  SELECT * FROM `masteritemtable`  "+WhereClause+" "+OrderByClause ;
...
/* Additional table opening method as MySQL supports pagination through limit and offset key words */	
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	   if(_conn==null) return null;
     _query =   "  SELECT * FROM `masteritemtable`  "+WhereClause+" "+OrderByClause+" LIMIT "+nLimit+" OFFSET "+nOffSet+" " ;
     _stmt = _conn.createStatement();
     _result  = _stmt.executeQuery(_query); 
     return _result ;
  } // end method openTable();
...
throws java.sql.SQLException 
{
 ...
 java.sql.Connection conn = Connect();
 if(conn==null) return 0;
 String query_count = "  SELECT COUNT(*) FROM `masteritemtable`  "+WhereClause;
    try
    {
...
} /* End of class declaration for MasteritemtableBean */	
