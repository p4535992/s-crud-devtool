...
/*
   ...
   The JDBC driver version is: mysql-connector-java-5.1.38 ( Revision: fe541c166cec739c74cc727c5da96c1028b4834a )
	 Autonumber column is: MailSingleAttachmentID

*/
public class Mail_singleattachmentsBean
{
	
/* JNDI data source name of database */
	public String _datasource = "jdbc/$DATABASE" ;
/* Table name in SQL databse */
	public String _tablename = "mail_singleattachments"; 
...
/* Variables corrosponding to table fields - field count: 7 */
	 
    public int MailSingleAttachmentID = 0 ;  
...
public void copyTo(com.db.$DATABASE.Mail_singleattachmentsBean other )
{
   other.MailSingleAttachmentID = this.MailSingleAttachmentID ;
...
public void copyFrom(com.db.$DATABASE.Mail_singleattachmentsBean other )
{
   this.MailSingleAttachmentID = other.MailSingleAttachmentID ;
...
throws java.sql.SQLException 
{
stmt.setInt( 1 , MailSingleAttachmentID ) ; 
stmt.setInt( 2 , MailSingleLogID ) ; 
stmt.setString( 3 , FileName ) ; 
stmt.setInt( 4 , FileSize ) ; 
stmt.setString( 5 , MimeType ) ; 
stmt.setString( 6 , ContentID ) ; 
...
throws java.sql.SQLException
{
MailSingleAttachmentID = rslt.getInt("MailSingleAttachmentID"); 
...
throws java.sql.SQLException 
{
 ...
 try{
    String query_add = " INSERT INTO `mail_singleattachments` ( `MailSingleAttachmentID`, `MailSingleLogID`, `FileName`, `FileSize`, `MimeType`, `ContentID`, `FileData` ) VALUES ( ?, ?, ?, ?, ?, ?, ?  ) ";
     ...
     */
     if ( _autonumber > 0 ) MailSingleAttachmentID = _autonumber ;
 ...
 throws java.sql.SQLException 
{
  ...
  String query_insert = " INSERT INTO `mail_singleattachments` ( `MailSingleAttachmentID`, `MailSingleLogID`, `FileName`, `FileSize`, `MimeType`, `ContentID`, `FileData` ) VALUES ( ?, ?, ?, ?, ?, ?, ?  ) ";
...
public boolean updateRecord(int update_MailSingleAttachmentID)
	throws java.sql.SQLException 
{
  ...
  try
	  {
    String query_update = " UPDATE `mail_singleattachments` SET `MailSingleAttachmentID` = ?, `MailSingleLogID` = ?, `FileName` = ?, `FileSize` = ?, `MimeType` = ?, `ContentID` = ?, `FileData` = ?  WHERE `mail_singleattachments`.`MailSingleAttachmentID` = "+update_MailSingleAttachmentID+" " ;
...
public boolean deleteRecord(int delete_MailSingleAttachmentID)
throws java.sql.SQLException 
{
 ...
 if(conn==null) return false ;
 try{
    String query_del = "  DELETE FROM `mail_singleattachments` WHERE `mail_singleattachments`.`MailSingleAttachmentID` = "+delete_MailSingleAttachmentID+" " ;
...
public boolean  locateRecord(int locate_MailSingleAttachmentID )
throws java.sql.SQLException 
{
 ...
 if(conn==null)return false;
 try{
    String query_locate = "  SELECT *  FROM `mail_singleattachments` WHERE  `mail_singleattachments`.`MailSingleAttachmentID` = "+locate_MailSingleAttachmentID+" " ;
...
throws java.sql.SQLException 
{
   ...
   try
	 {
    String query_locate_on_field = "  SELECT * FROM `mail_singleattachments`  WHERE `"+field+"` = '"+value+"' " ;
...
throws java.sql.SQLException 
{
   ...
   try
	{
		StringBuilder sbQry  = new StringBuilder( " SELECT * FROM `mail_singleattachments` WHERE ") ;
...
/* General purpose table opening method  */	
  ...
  throws java.sql.SQLException
  {
      ...
      _query =   "  SELECT * FROM `mail_singleattachments`  "+WhereClause+" "+OrderByClause ;
...
/* General purpose Join table opening method  */
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	    if(_conn==null) return null;
      _query =   "  SELECT * FROM `mail_singleattachments`  "+Join+" `"+JoinTableName+"` ON (`mail_singleattachments`.`"+OnIDField+"` = `"+JoinTableName+"`.`"+OnIDField+"`) "+WhereClause+" "+OrderByClause ;
      _stmt = _conn.createStatement();
      _result  = _stmt.executeQuery(_query); 
      return _result ;
...
/* Additional table opening method as MySQL supports pagination through limit and offset key words */	
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	   if(_conn==null) return null;
     _query =   "  SELECT * FROM `mail_singleattachments`  "+WhereClause+" "+OrderByClause+" LIMIT "+nLimit+" OFFSET "+nOffSet+" " ;
     _stmt = _conn.createStatement();
     _result  = _stmt.executeQuery(_query); 
     return _result ;
  } // end method openTable();
...
throws java.sql.SQLException 
{
 ...
 {
	query_count = "SELECT COUNT(*) FROM ( SELECT COUNT(*) FROM `mail_singleattachments`  "+WhereClause+") AS X ";
 }
 else
 {
	query_count = " SELECT COUNT(*) FROM `mail_singleattachments`  "+WhereClause;	 
 }	 
    try
    {
...
throws java.sql.SQLException 
{
 ...
 if(WhereClause.contains("GROUP BY"))
 {
	query_count = "SELECT COUNT(*) FROM ( SELECT COUNT(*) FROM `mail_singleattachments`  "+Join+" `"+JoinTableName+"` ON (`mail_singleattachments`.`"+OnIDField+"` = `"+JoinTableName+"`.`"+OnIDField+"`)  "+WhereClause+") AS X ";
 }
 else
 {
	query_count = " SELECT COUNT(*) FROM `mail_singleattachments`  "+Join+" `"+JoinTableName+"` ON (`mail_singleattachments`.`"+OnIDField+"` = `"+JoinTableName+"`.`"+OnIDField+"`)  "+WhereClause;	 
 }	 
    try
    {
    java.sql.Statement stmt_count = conn.createStatement();
...
} /* End of class declaration for Mail_singleattachmentsBean */	
