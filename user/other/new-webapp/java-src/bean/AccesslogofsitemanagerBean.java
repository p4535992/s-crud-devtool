...
public void copyTo(com.db.$DATABASE.AccesslogofsitemanagerBean other )
{
...
public void copyFrom(com.db.$DATABASE.AccesslogofsitemanagerBean other )
{
...
throws java.sql.SQLException 
{
 ...
 try{
    String query_add = " INSERT INTO `accesslogofsitemanager` ( `RecordID`, `AdminID`, `LoginTime`, `LogoutTime`, `IPAddress`, `Flag` ) VALUES ( ?, ?, ?, ?, ?, ?  ) ";
 ...
 throws java.sql.SQLException 
{
  ...
  String query_insert = " INSERT INTO `accesslogofsitemanager` ( `RecordID`, `AdminID`, `LoginTime`, `LogoutTime`, `IPAddress`, `Flag` ) VALUES ( ?, ?, ?, ?, ?, ?  ) ";
	...
	throws java.sql.SQLException 
{
  ...
  try
	  {
    String query_update = " UPDATE `accesslogofsitemanager` SET `RecordID` = ?, `AdminID` = ?, `LoginTime` = ?, `LogoutTime` = ?, `IPAddress` = ?, `Flag` = ?  WHERE `accesslogofsitemanager`.`RecordID` = "+update_RecordID+" " ;
...
throws java.sql.SQLException 
{
 ...
 if(conn==null) return false ;
 try{
    String query_del = "  DELETE FROM `accesslogofsitemanager` WHERE `accesslogofsitemanager`.`RecordID` = "+delete_RecordID+" " ;
...
throws java.sql.SQLException 
{
 ...
 if(conn==null)return false;
 try{
    String query_locate = "  SELECT *  FROM `accesslogofsitemanager` WHERE  `accesslogofsitemanager`.`RecordID` = "+locate_RecordID+" " ;
...
throws java.sql.SQLException 
{
   ...
   try
	 {
    String query_locate_on_field = "  SELECT * FROM `accesslogofsitemanager`  WHERE `"+field+"` = '"+value+"' " ;
...
/* General purpose table opening method  */	
  ...
  throws java.sql.SQLException
  {
      ...
      _query =   "  SELECT * FROM `accesslogofsitemanager`  "+WhereClause+" "+OrderByClause ;
...
/* Additional table opening method as MySQL supports pagination through limit and offset key words */	
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	   if(_conn==null) return null;
     _query =   "  SELECT * FROM `accesslogofsitemanager`  "+WhereClause+" "+OrderByClause+" LIMIT "+nLimit+" OFFSET "+nOffSet+" " ;
     _stmt = _conn.createStatement();
     _result  = _stmt.executeQuery(_query); 
     return _result ;
  } // end method openTable();
...
throws java.sql.SQLException 
{
 ...
 java.sql.Connection conn = Connect();
 if(conn==null) return 0;
 String query_count = "  SELECT COUNT(*) FROM `accesslogofsitemanager`  "+WhereClause;
    try
    {
...
} /* End of class declaration for AccesslogofsitemanagerBean */	
