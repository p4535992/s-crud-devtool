...
import  javax.sql.* ;	
/*
   Code generated on : 30/06/2016 06:31 PM
...
/* Table name in SQL databse */
	public String _tablename = "appsetting"; 
...
public void copyTo(com.db.$DATABASE.AppsettingBean other )
{
...
public void copyFrom(com.db.$DATABASE.AppsettingBean other )
{
...
throws java.sql.SQLException 
{
 ...
 try{
    String query_add = " INSERT INTO `appsetting` ( `RecordID`, `Type`, `Name`, `Description`, `Value`, `URL`, `UpdateDateTime` ) VALUES ( ?, ?, ?, ?, ?, ?, ?  ) ";
 ...
 throws java.sql.SQLException 
{
  ...
  String query_insert = " INSERT INTO `appsetting` ( `RecordID`, `Type`, `Name`, `Description`, `Value`, `URL`, `UpdateDateTime` ) VALUES ( ?, ?, ?, ?, ?, ?, ?  ) ";
	...
	throws java.sql.SQLException 
{
  ...
  try
	  {
    String query_update = " UPDATE `appsetting` SET `RecordID` = ?, `Type` = ?, `Name` = ?, `Description` = ?, `Value` = ?, `URL` = ?, `UpdateDateTime` = ?  WHERE `appsetting`.`RecordID` = "+update_RecordID+" " ;
...
throws java.sql.SQLException 
{
 ...
 if(conn==null) return false ;
 try{
    String query_del = "  DELETE FROM `appsetting` WHERE `appsetting`.`RecordID` = "+delete_RecordID+" " ;
...
throws java.sql.SQLException 
{
 ...
 if(conn==null)return false;
 try{
    String query_locate = "  SELECT *  FROM `appsetting` WHERE  `appsetting`.`RecordID` = "+locate_RecordID+" " ;
...
throws java.sql.SQLException 
{
   ...
   try
	 {
    String query_locate_on_field = "  SELECT * FROM `appsetting`  WHERE `"+field+"` = '"+value+"' " ;
...
/* General purpose table opening method  */	
  ...
  throws java.sql.SQLException
  {
      ...
      _query =   "  SELECT * FROM `appsetting`  "+WhereClause+" "+OrderByClause ;
...
/* Additional table opening method as MySQL supports pagination through limit and offset key words */	
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	   if(_conn==null) return null;
     _query =   "  SELECT * FROM `appsetting`  "+WhereClause+" "+OrderByClause+" LIMIT "+nLimit+" OFFSET "+nOffSet+" " ;
     _stmt = _conn.createStatement();
     _result  = _stmt.executeQuery(_query); 
     return _result ;
  } // end method openTable();
...
throws java.sql.SQLException 
{
 ...
 java.sql.Connection conn = Connect();
 if(conn==null) return 0;
 String query_count = "  SELECT COUNT(*) FROM `appsetting`  "+WhereClause;
    try
    {
...
} /* End of class declaration for AppsettingBean */	
