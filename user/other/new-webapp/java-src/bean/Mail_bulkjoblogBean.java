...
/*
   ...
   The JDBC driver version is: mysql-connector-java-5.1.38 ( Revision: fe541c166cec739c74cc727c5da96c1028b4834a )
	 Autonumber column is: MailBulkJobLogID

*/
public class Mail_bulkjoblogBean
{
	
/* JNDI data source name of database */
	public String _datasource = "jdbc/$DATABASE" ;
/* Table name in SQL databse */
	public String _tablename = "mail_bulkjoblog"; 
...
/* Variables corrosponding to table fields - field count: 9 */
	 
    public int MailBulkJobLogID = 0 ;  
    public int MailBulkJobID = 0 ;  
    public java.sql.Timestamp MailDispatchDateTime = null ;  
    public int RefNo = 0 ;  
    public String MailTo = "" ;  
    public String MailSubject = "" ;  
    public String MailText = "" ;  
    public short MailBulkJobLogFlag = (short)0 ;  
...
public void copyTo(com.db.$DATABASE.Mail_bulkjoblogBean other )
{
   other.MailBulkJobLogID = this.MailBulkJobLogID ;
   other.MailBulkJobID = this.MailBulkJobID ;
   other.MailDispatchDateTime = this.MailDispatchDateTime ;
   other.RefNo = this.RefNo ;
   other.MailTo = this.MailTo ;
   other.MailSubject = this.MailSubject ;
   other.MailText = this.MailText ;
   other.MailBulkJobLogFlag = this.MailBulkJobLogFlag ;
...
public void copyFrom(com.db.$DATABASE.Mail_bulkjoblogBean other )
{
   this.MailBulkJobLogID = other.MailBulkJobLogID ;
   this.MailBulkJobID = other.MailBulkJobID ;
   this.MailDispatchDateTime = other.MailDispatchDateTime ;
   this.RefNo = other.RefNo ;
   this.MailTo = other.MailTo ;
   this.MailSubject = other.MailSubject ;
   this.MailText = other.MailText ;
   this.MailBulkJobLogFlag = other.MailBulkJobLogFlag ;
...
{
	this.MailBulkJobLogID = 0 ; 
	this.MailBulkJobID = 0 ; 
	this.MailDispatchDateTime = null ; 
	this.RefNo = 0 ; 
	this.MailTo = "" ; 
	this.MailSubject = "" ; 
	this.MailText = "" ; 
	this.MailBulkJobLogFlag = (short)0 ; 
	this.Response = "" ; 
...
throws java.sql.SQLException 
{
stmt.setInt( 1 , MailBulkJobLogID ) ; 
stmt.setInt( 2 , MailBulkJobID ) ; 
stmt.setTimestamp( 3 , MailDispatchDateTime ) ; 
stmt.setInt( 4 , RefNo ) ; 
stmt.setString( 5 , MailTo ) ; 
stmt.setString( 6 , MailSubject ) ; 
stmt.setString( 7 , MailText ) ; 
stmt.setShort( 8 , MailBulkJobLogFlag ) ; 
...
throws java.sql.SQLException
{
MailBulkJobLogID = rslt.getInt("MailBulkJobLogID"); 
MailBulkJobID = rslt.getInt("MailBulkJobID"); 
MailDispatchDateTime = rslt.getTimestamp("MailDispatchDateTime"); 
RefNo = rslt.getInt("RefNo"); 
MailTo = rslt.getString("MailTo"); 
MailSubject = rslt.getString("MailSubject"); 
MailText = rslt.getString("MailText"); 
MailBulkJobLogFlag = rslt.getShort("MailBulkJobLogFlag"); 
...
throws java.sql.SQLException 
{
 ...
 try{
    String query_add = " INSERT INTO `mail_bulkjoblog` ( `MailBulkJobLogID`, `MailBulkJobID`, `MailDispatchDateTime`, `RefNo`, `MailTo`, `MailSubject`, `MailText`, `MailBulkJobLogFlag`, `Response` ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?  ) ";
     ...
     */
     if ( _autonumber > 0 ) MailBulkJobLogID = _autonumber ;
 ...
 throws java.sql.SQLException 
{
  ...
  String query_insert = " INSERT INTO `mail_bulkjoblog` ( `MailBulkJobLogID`, `MailBulkJobID`, `MailDispatchDateTime`, `RefNo`, `MailTo`, `MailSubject`, `MailText`, `MailBulkJobLogFlag`, `Response` ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?  ) ";
...
public boolean updateRecord(int update_MailBulkJobLogID)
	throws java.sql.SQLException 
{
  ...
  try
	  {
    String query_update = " UPDATE `mail_bulkjoblog` SET `MailBulkJobLogID` = ?, `MailBulkJobID` = ?, `MailDispatchDateTime` = ?, `RefNo` = ?, `MailTo` = ?, `MailSubject` = ?, `MailText` = ?, `MailBulkJobLogFlag` = ?, `Response` = ?  WHERE `mail_bulkjoblog`.`MailBulkJobLogID` = "+update_MailBulkJobLogID+" " ;
...
public boolean deleteRecord(int delete_MailBulkJobLogID)
throws java.sql.SQLException 
{
 ...
 if(conn==null) return false ;
 try{
    String query_del = "  DELETE FROM `mail_bulkjoblog` WHERE `mail_bulkjoblog`.`MailBulkJobLogID` = "+delete_MailBulkJobLogID+" " ;
...
public boolean  locateRecord(int locate_MailBulkJobLogID )
throws java.sql.SQLException 
{
 ...
 if(conn==null)return false;
 try{
    String query_locate = "  SELECT *  FROM `mail_bulkjoblog` WHERE  `mail_bulkjoblog`.`MailBulkJobLogID` = "+locate_MailBulkJobLogID+" " ;
...
throws java.sql.SQLException 
{
   ...
   try
	 {
    String query_locate_on_field = "  SELECT * FROM `mail_bulkjoblog`  WHERE `"+field+"` = '"+value+"' " ;
...
throws java.sql.SQLException 
{
   ...
   try
	{
		StringBuilder sbQry  = new StringBuilder( " SELECT * FROM `mail_bulkjoblog` WHERE ") ;
...
/* General purpose table opening method  */	
  ...
  throws java.sql.SQLException
  {
      ...
      _query =   "  SELECT * FROM `mail_bulkjoblog`  "+WhereClause+" "+OrderByClause ;
...
/* General purpose Join table opening method  */
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	    if(_conn==null) return null;
      _query =   "  SELECT * FROM `mail_bulkjoblog`  "+Join+" `"+JoinTableName+"` ON (`mail_bulkjoblog`.`"+OnIDField+"` = `"+JoinTableName+"`.`"+OnIDField+"`) "+WhereClause+" "+OrderByClause ;
      _stmt = _conn.createStatement();
      _result  = _stmt.executeQuery(_query); 
      return _result ;
...
/* Additional table opening method as MySQL supports pagination through limit and offset key words */	
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	   if(_conn==null) return null;
     _query =   "  SELECT * FROM `mail_bulkjoblog`  "+WhereClause+" "+OrderByClause+" LIMIT "+nLimit+" OFFSET "+nOffSet+" " ;
     _stmt = _conn.createStatement();
     _result  = _stmt.executeQuery(_query); 
     return _result ;
  } // end method openTable();
...
throws java.sql.SQLException 
{
 ...
 {
	query_count = "SELECT COUNT(*) FROM ( SELECT COUNT(*) FROM `mail_bulkjoblog`  "+WhereClause+") AS X ";
 }
 else
 {
	query_count = " SELECT COUNT(*) FROM `mail_bulkjoblog`  "+WhereClause;	 
 }	 
    try
    {
...
throws java.sql.SQLException 
{
 ...
 if(WhereClause.contains("GROUP BY"))
 {
	query_count = "SELECT COUNT(*) FROM ( SELECT COUNT(*) FROM `mail_bulkjoblog`  "+Join+" `"+JoinTableName+"` ON (`mail_bulkjoblog`.`"+OnIDField+"` = `"+JoinTableName+"`.`"+OnIDField+"`)  "+WhereClause+") AS X ";
 }
 else
 {
	query_count = " SELECT COUNT(*) FROM `mail_bulkjoblog`  "+Join+" `"+JoinTableName+"` ON (`mail_bulkjoblog`.`"+OnIDField+"` = `"+JoinTableName+"`.`"+OnIDField+"`)  "+WhereClause;	 
 }	 
    try
    {
    java.sql.Statement stmt_count = conn.createStatement();
...
} /* End of class declaration for Mail_bulkjoblogBean */	
