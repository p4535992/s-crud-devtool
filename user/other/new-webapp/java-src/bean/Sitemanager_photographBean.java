...
import  javax.sql.* ;	
/*
   Code generated on : 05/06/2016 01:25 PM
...
public void copyTo(com.db.$DATABASE.Sitemanager_photographBean other )
{
   other.RecordID = this.RecordID ;
   other.AdminID = this.AdminID ;
   other.FileName = this.FileName ;
   other.Photograph = this.Photograph ;
...
public void copyFrom(com.db.$DATABASE.Sitemanager_photographBean other )
{
...
Photograph = rslt.getBytes("Photograph"); 
...
throws java.sql.SQLException 
{
 ...
 try{
    String query_add = " INSERT INTO `sitemanager_photograph` ( `RecordID`, `AdminID`, `FileName`, `Photograph`, `FileSize`, `MIMEType`, `UpdateDateTime` ) VALUES ( ?, ?, ?, ?, ?, ?, ?  ) ";
 ...
 throws java.sql.SQLException 
{
  ...
  String query_insert = " INSERT INTO `sitemanager_photograph` ( `RecordID`, `AdminID`, `FileName`, `Photograph`, `FileSize`, `MIMEType`, `UpdateDateTime` ) VALUES ( ?, ?, ?, ?, ?, ?, ?  ) ";
	...
	throws java.sql.SQLException 
{
  ...
  try
	  {
    String query_update = " UPDATE `sitemanager_photograph` SET `RecordID` = ?, `AdminID` = ?, `FileName` = ?, `Photograph` = ?, `FileSize` = ?, `MIMEType` = ?, `UpdateDateTime` = ?  WHERE `sitemanager_photograph`.`RecordID` = "+update_RecordID+" " ;
...
throws java.sql.SQLException 
{
 ...
 if(conn==null) return false ;
 try{
    String query_del = "  DELETE FROM `sitemanager_photograph` WHERE `sitemanager_photograph`.`RecordID` = "+delete_RecordID+" " ;
...
throws java.sql.SQLException 
{
 ...
 if(conn==null)return false;
 try{
    String query_locate = "  SELECT *  FROM `sitemanager_photograph` WHERE  `sitemanager_photograph`.`RecordID` = "+locate_RecordID+" " ;
...
throws java.sql.SQLException 
{
   ...
   try
	 {
    String query_locate_on_field = "  SELECT * FROM `sitemanager_photograph`  WHERE `"+field+"` = '"+value+"' " ;
...
/* General purpose table opening method  */	
  ...
  throws java.sql.SQLException
  {
      ...
      _query =   "  SELECT * FROM `sitemanager_photograph`  "+WhereClause+" "+OrderByClause ;
...
/* Additional table opening method as MySQL supports pagination through limit and offset key words */	
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	   if(_conn==null) return null;
     _query =   "  SELECT * FROM `sitemanager_photograph`  "+WhereClause+" "+OrderByClause+" LIMIT "+nLimit+" OFFSET "+nOffSet+" " ;
     _stmt = _conn.createStatement();
     _result  = _stmt.executeQuery(_query); 
     return _result ;
  } // end method openTable();
...
throws java.sql.SQLException 
{
 ...
 java.sql.Connection conn = Connect();
 if(conn==null) return 0;
 String query_count = "  SELECT COUNT(*) FROM `sitemanager_photograph`  "+WhereClause;
    try
    {
...
} /* End of class declaration for Sitemanager_photographBean */	
