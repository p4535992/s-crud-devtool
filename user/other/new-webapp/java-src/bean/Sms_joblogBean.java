...
/* Variables corrosponding to table fields - field count: 10 */
    ...
    public int SmsJobLogID = 0 ;  
    public int SmsJobID = 0 ;  
    public java.sql.Timestamp DispatchDateTime = null ;  
    public String RefNo = "" ;  
    public String Target = "" ;  
    public String MobileNumber = "" ;  
    public String SMSText = "" ;  
    public short MobileNumberStatus = (short)0 ;  
    public short SmsJobLogFlag = (short)0 ;  
...
public void copyTo(com.db.$DATABASE.Sms_joblogBean other )
{
   other.SmsJobLogID = this.SmsJobLogID ;
   other.SmsJobID = this.SmsJobID ;
   other.DispatchDateTime = this.DispatchDateTime ;
   other.RefNo = this.RefNo ;
   other.Target = this.Target ;
   other.MobileNumber = this.MobileNumber ;
   other.SMSText = this.SMSText ;
   other.MobileNumberStatus = this.MobileNumberStatus ;
   other.SmsJobLogFlag = this.SmsJobLogFlag ;
...
public void copyFrom(com.db.$DATABASE.Sms_joblogBean other )
{
   this.SmsJobLogID = other.SmsJobLogID ;
   this.SmsJobID = other.SmsJobID ;
   this.DispatchDateTime = other.DispatchDateTime ;
   this.RefNo = other.RefNo ;
   this.Target = other.Target ;
   this.MobileNumber = other.MobileNumber ;
   this.SMSText = other.SMSText ;
   this.MobileNumberStatus = other.MobileNumberStatus ;
   this.SmsJobLogFlag = other.SmsJobLogFlag ;
...
public void clearData()
{
	...
	this.MobileNumber = "" ; 
	this.SMSText = "" ; 
	this.MobileNumberStatus = (short)0 ; 
	this.SmsJobLogFlag = (short)0 ; 
	this.Response = "" ; 
...
throws java.sql.SQLException 
{
stmt.setInt( 1 , SmsJobLogID ) ; 
stmt.setInt( 2 , SmsJobID ) ; 
stmt.setTimestamp( 3 , DispatchDateTime ) ; 
stmt.setString( 4 , RefNo ) ; 
stmt.setString( 5 , Target ) ; 
stmt.setString( 6 , MobileNumber ) ; 
stmt.setString( 7 , SMSText ) ; 
stmt.setShort( 8 , MobileNumberStatus ) ; 
stmt.setShort( 9 , SmsJobLogFlag ) ; 
...
throws java.sql.SQLException
{
SmsJobLogID = rslt.getInt("SmsJobLogID"); 
SmsJobID = rslt.getInt("SmsJobID"); 
DispatchDateTime = rslt.getTimestamp("DispatchDateTime"); 
RefNo = rslt.getString("RefNo"); 
Target = rslt.getString("Target"); 
MobileNumber = rslt.getString("MobileNumber"); 
SMSText = rslt.getString("SMSText"); 
MobileNumberStatus = rslt.getShort("MobileNumberStatus"); 
SmsJobLogFlag = rslt.getShort("SmsJobLogFlag"); 
...
throws java.sql.SQLException 
{
 ...
 try{
    String query_add = " INSERT INTO `sms_joblog` ( `SmsJobLogID`, `SmsJobID`, `DispatchDateTime`, `RefNo`, `Target`, `MobileNumber`, `SMSText`, `MobileNumberStatus`, `SmsJobLogFlag`, `Response` ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?  ) ";
     ...
     */
     if ( _autonumber > 0 ) SmsJobLogID = _autonumber ;
 ...
 throws java.sql.SQLException 
{
  ...
  String query_insert = " INSERT INTO `sms_joblog` ( `SmsJobLogID`, `SmsJobID`, `DispatchDateTime`, `RefNo`, `Target`, `MobileNumber`, `SMSText`, `MobileNumberStatus`, `SmsJobLogFlag`, `Response` ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?  ) ";
...
public boolean updateRecord(int update_SmsJobLogID)
	throws java.sql.SQLException 
{
  ...
  try
	  {
    String query_update = " UPDATE `sms_joblog` SET `SmsJobLogID` = ?, `SmsJobID` = ?, `DispatchDateTime` = ?, `RefNo` = ?, `Target` = ?, `MobileNumber` = ?, `SMSText` = ?, `MobileNumberStatus` = ?, `SmsJobLogFlag` = ?, `Response` = ?  WHERE `sms_joblog`.`SmsJobLogID` = "+update_SmsJobLogID+" " ;
...
public boolean deleteRecord(int delete_SmsJobLogID)
throws java.sql.SQLException 
{
 ...
 if(conn==null) return false ;
 try{
    String query_del = "  DELETE FROM `sms_joblog` WHERE `sms_joblog`.`SmsJobLogID` = "+delete_SmsJobLogID+" " ;
...
public boolean  locateRecord(int locate_SmsJobLogID )
throws java.sql.SQLException 
{
 ...
 if(conn==null)return false;
 try{
    String query_locate = "  SELECT *  FROM `sms_joblog` WHERE  `sms_joblog`.`SmsJobLogID` = "+locate_SmsJobLogID+" " ;
...
throws java.sql.SQLException 
{
   ...
   try
	 {
    String query_locate_on_field = "  SELECT * FROM `sms_joblog`  WHERE `"+field+"` = '"+value+"' " ;
...
throws java.sql.SQLException 
{
   ...
   try
	{
		StringBuilder sbQry  = new StringBuilder( " SELECT * FROM `sms_joblog` WHERE ") ;
...
/* General purpose table opening method  */	
  ...
  throws java.sql.SQLException
  {
      ...
      _query =   "  SELECT * FROM `sms_joblog`  "+WhereClause+" "+OrderByClause ;
...
/* General purpose Join table opening method  */
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	    if(_conn==null) return null;
      _query =   "  SELECT * FROM `sms_joblog`  "+Join+" `"+JoinTableName+"` ON (`sms_joblog`.`"+OnIDField+"` = `"+JoinTableName+"`.`"+OnIDField+"`) "+WhereClause+" "+OrderByClause ;
      _stmt = _conn.createStatement();
      _result  = _stmt.executeQuery(_query); 
      return _result ;
...
/* Additional table opening method as MySQL supports pagination through limit and offset key words */	
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	   if(_conn==null) return null;
     _query =   "  SELECT * FROM `sms_joblog`  "+WhereClause+" "+OrderByClause+" LIMIT "+nLimit+" OFFSET "+nOffSet+" " ;
     _stmt = _conn.createStatement();
     _result  = _stmt.executeQuery(_query); 
     return _result ;
  } // end method openTable();
...
throws java.sql.SQLException 
{
 ...
 {
	query_count = "SELECT COUNT(*) FROM ( SELECT COUNT(*) FROM `sms_joblog`  "+WhereClause+") AS X ";
 }
 else
 {
	query_count = " SELECT COUNT(*) FROM `sms_joblog`  "+WhereClause;	 
 }	 
    try
    {
...
throws java.sql.SQLException 
{
 ...
 if(WhereClause.contains("GROUP BY"))
 {
	query_count = "SELECT COUNT(*) FROM ( SELECT COUNT(*) FROM `sms_joblog`  "+Join+" `"+JoinTableName+"` ON (`sms_joblog`.`"+OnIDField+"` = `"+JoinTableName+"`.`"+OnIDField+"`)  "+WhereClause+") AS X ";
 }
 else
 {
	query_count = " SELECT COUNT(*) FROM `sms_joblog`  "+Join+" `"+JoinTableName+"` ON (`sms_joblog`.`"+OnIDField+"` = `"+JoinTableName+"`.`"+OnIDField+"`)  "+WhereClause;	 
 }	 
    try
    {
    java.sql.Statement stmt_count = conn.createStatement();
...
} /* End of class declaration for Sms_joblogBean */	
