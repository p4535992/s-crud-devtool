...
/*
   ...
   The JDBC driver version is: mysql-connector-java-5.1.38 ( Revision: fe541c166cec739c74cc727c5da96c1028b4834a )
	 Autonumber column is: SmsSingleLogID

*/
public class Sms_singlelogBean
{
	
/* JNDI data source name of database */
	public String _datasource = "jdbc/$DATABASE" ;
/* Table name in SQL databse */
	public String _tablename = "sms_singlelog"; 
...
/* Variables corrosponding to table fields - field count: 9 */
    ...
    public short SmsSingleLogFlag = (short)0 ;  
...
public void copyTo(com.db.$DATABASE.Sms_singlelogBean other )
{
   other.SmsSingleLogID = this.SmsSingleLogID ;
   ...
   other.SmsSingleLogFlag = this.SmsSingleLogFlag ;
...
public void copyFrom(com.db.$DATABASE.Sms_singlelogBean other )
{
   this.SmsSingleLogID = other.SmsSingleLogID ;
   ...
   this.SmsSingleLogFlag = other.SmsSingleLogFlag ;
...
throws java.sql.SQLException
{
SmsSingleLogID = rslt.getInt("SmsSingleLogID"); 
...
SmsSingleLogFlag = rslt.getShort("SmsSingleLogFlag"); 
...
throws java.sql.SQLException 
{
 ...
 try{
    String query_add = " INSERT INTO `sms_singlelog` ( `SmsSingleLogID`, `ExecuteBy`, `ExecutorID`, `DispatchDateTime`, `AccountID`, `MobileNumber`, `SMSText`, `SmsSingleLogFlag`, `Response` ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?  ) ";
     ...
     */
     if ( _autonumber > 0 ) SmsSingleLogID = _autonumber ;
 ...
 throws java.sql.SQLException 
{
  ...
  String query_insert = " INSERT INTO `sms_singlelog` ( `SmsSingleLogID`, `ExecuteBy`, `ExecutorID`, `DispatchDateTime`, `AccountID`, `MobileNumber`, `SMSText`, `SmsSingleLogFlag`, `Response` ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?  ) ";
...
public boolean updateRecord(int update_SmsSingleLogID)
	throws java.sql.SQLException 
{
  ...
  try
	  {
    String query_update = " UPDATE `sms_singlelog` SET `SmsSingleLogID` = ?, `ExecuteBy` = ?, `ExecutorID` = ?, `DispatchDateTime` = ?, `AccountID` = ?, `MobileNumber` = ?, `SMSText` = ?, `SmsSingleLogFlag` = ?, `Response` = ?  WHERE `sms_singlelog`.`SmsSingleLogID` = "+update_SmsSingleLogID+" " ;
...
public boolean deleteRecord(int delete_SmsSingleLogID)
throws java.sql.SQLException 
{
 ...
 if(conn==null) return false ;
 try{
    String query_del = "  DELETE FROM `sms_singlelog` WHERE `sms_singlelog`.`SmsSingleLogID` = "+delete_SmsSingleLogID+" " ;
...
public boolean  locateRecord(int locate_SmsSingleLogID )
throws java.sql.SQLException 
{
 ...
 if(conn==null)return false;
 try{
    String query_locate = "  SELECT *  FROM `sms_singlelog` WHERE  `sms_singlelog`.`SmsSingleLogID` = "+locate_SmsSingleLogID+" " ;
...
throws java.sql.SQLException 
{
   ...
   try
	 {
    String query_locate_on_field = "  SELECT * FROM `sms_singlelog`  WHERE `"+field+"` = '"+value+"' " ;
...
throws java.sql.SQLException 
{
   ...
   try
	{
		StringBuilder sbQry  = new StringBuilder( " SELECT * FROM `sms_singlelog` WHERE ") ;
...
/* General purpose table opening method  */	
  ...
  throws java.sql.SQLException
  {
      ...
      _query =   "  SELECT * FROM `sms_singlelog`  "+WhereClause+" "+OrderByClause ;
...
/* General purpose Join table opening method  */
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	    if(_conn==null) return null;
      _query =   "  SELECT * FROM `sms_singlelog`  "+Join+" `"+JoinTableName+"` ON (`sms_singlelog`.`"+OnIDField+"` = `"+JoinTableName+"`.`"+OnIDField+"`) "+WhereClause+" "+OrderByClause ;
      _stmt = _conn.createStatement();
      _result  = _stmt.executeQuery(_query); 
      return _result ;
...
/* Additional table opening method as MySQL supports pagination through limit and offset key words */	
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	   if(_conn==null) return null;
     _query =   "  SELECT * FROM `sms_singlelog`  "+WhereClause+" "+OrderByClause+" LIMIT "+nLimit+" OFFSET "+nOffSet+" " ;
     _stmt = _conn.createStatement();
     _result  = _stmt.executeQuery(_query); 
     return _result ;
  } // end method openTable();
...
throws java.sql.SQLException 
{
 ...
 {
	query_count = "SELECT COUNT(*) FROM ( SELECT COUNT(*) FROM `sms_singlelog`  "+WhereClause+") AS X ";
 }
 else
 {
	query_count = " SELECT COUNT(*) FROM `sms_singlelog`  "+WhereClause;	 
 }	 
    try
    {
...
throws java.sql.SQLException 
{
 ...
 if(WhereClause.contains("GROUP BY"))
 {
	query_count = "SELECT COUNT(*) FROM ( SELECT COUNT(*) FROM `sms_singlelog`  "+Join+" `"+JoinTableName+"` ON (`sms_singlelog`.`"+OnIDField+"` = `"+JoinTableName+"`.`"+OnIDField+"`)  "+WhereClause+") AS X ";
 }
 else
 {
	query_count = " SELECT COUNT(*) FROM `sms_singlelog`  "+Join+" `"+JoinTableName+"` ON (`sms_singlelog`.`"+OnIDField+"` = `"+JoinTableName+"`.`"+OnIDField+"`)  "+WhereClause;	 
 }	 
    try
    {
    java.sql.Statement stmt_count = conn.createStatement();
...
} /* End of class declaration for Sms_singlelogBean */	
