...
public class MailSetting
{
    public final short NONE = 0;
	  ...
	  public MailSetting(String data_src )
	  {
	      this.jndidsn = data_src;
	  }

		public MailSetting(ServletContext cntx)
		{
		   this.jndidsn = cntx.getInitParameter("MAIL-DATASOURCE");
			 if( this.jndidsn==null ) this.jndidsn="jdbc/$WEBAPP" ; // Assume defualt value if not set
	  }

	 public boolean getServiceStatus()
	 {
	     String val =  getValue("START-SMTP-SERVICE");
	 ...
	 public boolean lookup( String itemname)
	 {
	     ...
	     try
	     {
	           ...
	           java.sql.Connection conn = source.getConnection();
		         String Qry =  " SELECT  * FROM \"settings\" WHERE \"settings\".\"Name\" = '"+itemname+"' "  ;
		         try
		         {
         ...
         try
         {
             Context env = (Context) new InitialContext().lookup("java:comp/env");
         	   ...
         	   try
         	           ...
         	           String updateQry =   " UPDATE \"settings\" SET \"settings\".\"Value\" = '"+newvalue+"' WHERE \"settings\".\"Name\" = '"+itemname+"' "  ;
    ...
    public boolean updateSettingItemAndURL(String itemname, String itemval, String URLval )
    {
         ...
         try
         {
             ...
             try
						 {
          	      conn = source.getConnection();
          	      String updateQry =  " UPDATE \"settings\" SET \"settings\".\"Value\" = '"+itemval+"', \"settings\".\"URL\" = '"+URLval +"' WHERE \"settings\".\"Name\" = '"+itemname+"' "  ;
          	      java.sql.Statement stmtUpdate = conn.createStatement();
                  if( stmtUpdate.executeUpdate(updateQry)==1 ) bStatus  = true ;
          	      stmtUpdate.close();
          	 }
