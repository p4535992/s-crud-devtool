    ...
    public static String getDropList(String ElmName, String ElmID, short item, boolean all_label, boolean none_label, String cls, String plugin)		 
     {
          ...
          sb.append("<option value=\"" + CREATE + "\"" + ((item == CREATE) ? sel : " ") + " > Create </option>\r\n");     
          sb.append("<option value=\"" + DELETE + "\"" + ((item == DELETE) ? sel : " ") + " > Delete </option>\r\n");     
          sb.append("</select>\r\n");
          return sb.toString();										 
     ...
     public static String getRadioButtons(String Elm, short item,  String cls)		 
     {
          ...
          sb.append("   | ");
          sb.append("<input type=\"radio\" name=\"" + Elm + "\" value=\"" + CREATE + "\"" + ((item == CREATE) ? chk : " ") + " " + cls_name + "  /> Create\r\n");
          sb.append("   | ");
          sb.append("<input type=\"radio\" name=\"" + Elm + "\" value=\"" + DELETE + "\"" + ((item == DELETE) ? chk : " ") + " " + cls_name + "  /> Delete\r\n");
          return sb.toString();				
     ...
     public static String getCheckBoxes(String Elm, String selCsv, String cls)		 
     {
          ...
          sb.append("<input type=\"checkbox\" name=\"" + Elm + "\" value=\"" + CREATE + "\"" + ((hs.contains(new Short(CREATE))) ? chk : " ") + " " + cls_name + "  /> Create\r\n");   
          sb.append("<input type=\"checkbox\" name=\"" + Elm + "\" value=\"" + DELETE + "\"" + ((hs.contains(new Short(DELETE))) ? chk : " ") + " " + cls_name + "  /> Delete\r\n");   
          return sb.toString();				
     }	// End method:  getCheckBoxes(String Elm, String selCsv)				 

     public static String getJSONString()
     {
         return "{\"0\":\"Unknown\",\"1\":\"Create\",\"2\":\"Delete\"}" ;
     } // End method getJSONString()
		 
		 
     public static short[] items()
     {
         return new short[]{ UNKNOWN, CREATE, DELETE } ;
     } // End method items()
     ...
     public static TreeMap itemMap()
     {
         ...
         mp.put( new Short(CREATE), "Create");
         mp.put( new Short(DELETE), "Delete");
       	 return mp ;    
     } // End method itemMap()
