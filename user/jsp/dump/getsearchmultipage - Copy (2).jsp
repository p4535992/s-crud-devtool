...
%>
  ...
  <span class="input-group-btn">
	  <button class="btn btn-primary" type="button" onclick="{ $('#repag_div').slideToggle(); }"><%=GOTO %></button>
	</span>
</div>
</td>
<td width="20%" align="center" >
...
<div id="repag_div_footer" style="display:none;margin-bottom: 10px;">
<div class="input-group col-sm-2 col-sm-offset-5">
  <input type="text" name="RowCount" id="RowCount" class="form-control" value="<\%=QryObj.pagesize %>" >
  <span class="input-group-btn"><button type="button" class="btn btn-primary" onclick="RePaginate()">Re-Paginate</button></span>
</div>
...
%>
  ...
  <span class="input-group-btn">
	  <button class="btn btn-primary" type="button" onclick="{ $('#repag_div_footer').slideToggle(); }"><%=GOTO %></button>
	</span>
</div>
</td>
<td width="20%" align="center" >
...
<div class="panel">
  <div class="panel-heading">
    <h3 class="panel-title page-title-action"><\%=PageTitle %>
		<button class="btn btn-icon btn-dark btn-outline btn-round btn-sm pull-right" type="button" style="font-size: 10px;margin-left: 5px;" data-original-title="cancel" data-placement="bottom" data-toggle="tooltip" data-trigger="hover" onclick="history.go(-1);"><i aria-hidden="true" class="icon wb-close" style="margin: 0;"></i></button>
		<\% if(bAllowDelete == true){ %>
		<button class="btn btn-icon btn-dark btn-outline btn-round btn-sm pull-right" type="button" style="font-size: 10px;margin-left: 5px;" data-original-title="Delete" data-placement="bottom" data-toggle="tooltip" data-trigger="hover" onclick="DeleteRecord('<\%=<%=BeanName  %>.<%=IDField  %> %>', '<\%=DelWarning %>', '<\%=thisFile %>?Action=Delete<\%=ForeignKeyParam %><\%=ReturnPathLink %>&<%=IDField  %>=<\%=<%=BeanName  %>.<%=IDField  %> %>' )"><i aria-hidden="true" class="icon wb-trash" style="margin: 0;"></i></button>
		<\% } %>
		<\% if(bAllowUpdate == true){ %>
