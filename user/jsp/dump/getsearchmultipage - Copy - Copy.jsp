...
<td width="25%" align="center">
 <\% if(bAllowAdd == true){ %> <a href="<\%=thisFile %>?Action=New<\%=ForeignKeyParam %><\%=ReturnPathLink %>"><b>Create New <%=EntityName %>'s Record</b></a> <\% } %>
</td>
<td width="25%" align="right">
  <a href="<\%=thisFile %>?Action=Search<\%=ForeignKeyParam %><\%=ReturnPathLink %>"><b> &lsaquo;&lsaquo;Search Again</b></a>
</td>
</tr>
</table>
<% if( bAltTxt )
