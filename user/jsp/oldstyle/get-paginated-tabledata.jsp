...
String ParamChain = "&Rand="+nRand;
*/
String ParamChain = ReturnPathLink;
...
<table width="100%">
<tr>
	<td valign="top" align="left" width="70%" ><span class="title">Paginated data for table: <%=TableName %> </span></td>
