...
<tr>
<td width="70%" align="left"><span class="title">List of <%=EntityName %>'s Records:  </span>( <\%=ResultCount %> Records )</td>
<td width="25%" align="center"><a href="<\%=thisFile %>?Action=New<\%=ForeignKeyParam %><\%=ReturnPathLink %>"><b>Create New <%=EntityName %></b></a></td>
</tr>
</table>
<\% 
if(ResultCount > 0)
