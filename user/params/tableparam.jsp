<%@ page import="java.io.*"%><%@ page import="java.util.*"%><%@ page import="java.sql.*"%><%@ page import="javax.servlet.*"%><%@ page import="javax.servlet.http.*"%><%@ page import="javax.naming.*" %><%@ page import="javax.sql.*" %><%@ page import="com.beanwiz.*, com.webapp.utils.*" %><%@ page contentType="text/plain" %>
...
{	
	 ...
	 dump.append("\r\n// Column No: ["+n+"] "+ColName+" "+ColTypeName+ " ( "+Precision+","+Scale+" )\r\n");
	 ...
	 if( rsmd.isAutoIncrement(n) )   dump.append("/* Auto increment column: \r\n" ) ; 
	       ...
	       switch(nJdbcType)
	       {
	          case java.sql.Types.BINARY:
		        //		VarType =  "byte[]" ;
			        dump.append("// $CODE Binary Data 	//");
				      ...
				      dump.append("$BEAN"+"."+ColVarName+" = new byte["+ColVarName+"_Stream.available()] ;\r\n ");
	 			      dump.append( ColVarName+"_Stream.read( "+"$BEAN"+"."+ColVarName+", 0, "+ColVarName+"_Stream.available()); \r\n }\r\n}\r\n ");
			      break ;
			 
            case java.sql.Types.BIGINT:
	          //		VarType =  "long" ;
	            dump.append("try{ \r\n ");
	            dump.append("\t"+"$BEAN"+"."+ColVarName+" = Long.parseLong(request.getParameter(\""+ColName+"\")) ;\r\n ");
	          ...
	          // 	VarType =  "boolean" ;
	            dump.append("try{ \r\n ");
	            dump.append("\t"+"$BEAN"+"."+ColVarName+" = ( Byte.parseByte(request.getParameter(\""+ColName+"\")))>0? true:false ;\r\n ");
	            dump.append("} catch( NumberFormatException ex)\r\n { \r\n\t"+"$BEAN"+"."+ColVarName+" = false ;\r\n }\r\n");
  	        break ;
	          ...
	          //		VarType =  "String" ;
		          dump.append(""+"$BEAN"+"."+ColVarName+" = request.getParameter(\""+ColName+"\");\r\n");
            break;
            ...
            break ;
              ...
              dump.append("$BEAN"+"."+ColVarName+" = com.webapp.utils.DateHelper.requestDate( request, \""+ColName+"\" );\r\n");
            break ;
	                
	          case java.sql.Types.DECIMAL:
	 	        //	VarType =  "java.math.BigDecimal" ;
		          dump.append("try{\r\n\t"+"$BEAN"+"."+ColVarName+"  =  new BigDecimal( request.getParameter(\""+ColName+"\"));\r\n}\r\n");
		          dump.append("catch( NumberFormatException ex )\r\n{\r\n\t");
		          dump.append("$BEAN"+"."+ColVarName+"  =  new BigDecimal((double)0) ; ");
		          dump.append("}\r\n");	
		        break ;
	          ...
	          case java.sql.Types.DOUBLE:
 			      // VarType =  "double" ;
	 		        dump.append("try{ \r\n ");
	 		        dump.append("\t"+"$BEAN"+"."+ColVarName+" = Double.parseDouble(request.getParameter(\""+ColName+"\")) ;\r\n ");
	 		        dump.append("} catch( NumberFormatException ex)\r\n { \r\n\t"+"$BEAN"+"."+ColVarName+" = 0 ;\r\n }\r\n");
		        break ;
	          ...
	          case java.sql.Types.FLOAT:
	 		      //	VarType =  "float" ;
	 		        dump.append("try{ \r\n ");
	 		        dump.append("\t"+"$BEAN"+"."+ColVarName+" = Float.parseFloat(request.getParameter(\""+ColName+"\")) ;\r\n ");
	 		        dump.append("} catch( NumberFormatException ex)\r\n { \r\n\t"+"$BEAN"+"."+ColVarName+" = 0 ;\r\n }\r\n");
	          break ;
	          ...
	          case java.sql.Types.INTEGER:
	 		      //	VarType =  "int" ;
	            dump.append("try{ \r\n ");
	            dump.append("\t"+"$BEAN"+"."+ColVarName+" = Integer.parseInt(request.getParameter(\""+ColName+"\")) ;\r\n ");
	            dump.append("} catch( NumberFormatException ex)\r\n { \r\n\t"+"$BEAN"+"."+ColVarName+" = 0 ;\r\n }\r\n");
            break ;
            ...
            break ;
	          ...
	          case java.sql.Types.SMALLINT:
	  	      //	VarType =  "short" ;
	            dump.append("try{ \r\n ");
	            dump.append("\t"+"$BEAN"+"."+ColVarName+" = Short.parseShort(request.getParameter(\""+ColName+"\")) ;\r\n ");
	            dump.append("} catch( NumberFormatException ex)\r\n { \r\n\t"+"$BEAN"+"."+ColVarName+" = 0 ;\r\n }\r\n");
            break ;
	          ...
	          case java.sql.Types.TIME:
	   	      //			VarType =  "java.sql.Time" ;
		          dump.append("$BEAN"+"."+ColVarName+" = com.webapp.utils.DateHelper.requestTime( request, \""+ColName+"\" );\r\n");
			      break ;
	                 
	          case java.sql.Types.TIMESTAMP:
	 		      //				VarType =  "java.sql.Timestamp" ;
		          dump.append("$BEAN"+"."+ColVarName+" = com.webapp.utils.DateHelper.requestDateTime( request, \""+ColName+"\" );\r\n ") ;
            break ;		
                     
	          case java.sql.Types.TINYINT:
	          //		VarType =  "byte" ;
       	      dump.append("try{ \r\n ");
	            dump.append("\t"+"$BEAN"+"."+ColVarName+" = Byte.parseByte(request.getParameter(\""+ColName+"\")) ;\r\n ");
	            dump.append("} catch( NumberFormatException ex)\r\n { \r\n\t"+"$BEAN"+"."+ColVarName+" = 0 ;\r\n }\r\n");
            break ;
