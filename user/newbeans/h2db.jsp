...
The code is  customized for H2 Database JDBC Driver.
...
throws java.sql.SQLException 
{
 ...
 catch(javax.naming.NamingException ex)
 {
  ...
  try
   ...
   conx = DriverManager.getConnection ("jdbc:h2:C:/path/datafile", "sa", "");
  }
...
/* Additional table opening method as H2 database supports pagination through limit and offset key words */	
