...
The code is  customized for MS SQL Server
          ...
          try
	        {
               ...
               conx = DriverManager.getConnection ("jdbc:sqlserver://localhost:1433;databaseName=<%=JNDIDSN.substring("jdbc/".length() ) %>;user=MyUserName;password=*****;");
					}
