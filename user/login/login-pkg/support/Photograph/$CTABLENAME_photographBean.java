...
public void copyTo(com.db.$DATABASE.$CTABLENAME_photographBean other )
{
   other.RecordID = this.RecordID ;
   other.$IDFIELD = this.$IDFIELD ;
...
public void copyFrom(com.db.$DATABASE.$CTABLENAME_photographBean other )
{
...
throws java.sql.SQLException 
{
 ...
 try{
    String query_add = " INSERT INTO `$TABLENAME_photograph` ( `RecordID`, `$IDFIELD`, `FileName`, `Photograph`, `FileSize`, `MIMEType`, `UpdateDateTime` ) VALUES ( ?, ?, ?, ?, ?, ?, ?  ) ";
 ...
 throws java.sql.SQLException 
{
  ...
  String query_insert = " INSERT INTO `$TABLENAME_photograph` ( `RecordID`, `$IDFIELD`, `FileName`, `Photograph`, `FileSize`, `MIMEType`, `UpdateDateTime` ) VALUES ( ?, ?, ?, ?, ?, ?, ?  ) ";
	...
	throws java.sql.SQLException 
{
  ...
  try
	  {
    String query_update = " UPDATE `$TABLENAME_photograph` SET `RecordID` = ?, `$IDFIELD` = ?, `FileName` = ?, `Photograph` = ?, `FileSize` = ?, `MIMEType` = ?, `UpdateDateTime` = ?  WHERE `$TABLENAME_photograph`.`RecordID` = "+update_RecordID+" " ;
...
throws java.sql.SQLException 
{
 ...
 if(conn==null) return false ;
 try{
    String query_del = "  DELETE FROM `$TABLENAME_photograph` WHERE `$TABLENAME_photograph`.`RecordID` = "+delete_RecordID+" " ;
...
throws java.sql.SQLException 
{
 ...
 if(conn==null)return false;
 try{
    String query_locate = "  SELECT *  FROM `$TABLENAME_photograph` WHERE  `$TABLENAME_photograph`.`RecordID` = "+locate_RecordID+" " ;
...
throws java.sql.SQLException 
{
   ...
   try
	 {
    String query_locate_on_field = "  SELECT * FROM `$TABLENAME_photograph`  WHERE `"+field+"` = '"+value+"' " ;
...
/* General purpose table opening method  */	
  ...
  throws java.sql.SQLException
  {
      ...
      _query =   "  SELECT * FROM `$TABLENAME_photograph`  "+WhereClause+" "+OrderByClause ;
...
/* Additional table opening method as MySQL supports pagination through limit and offset key words */	
  ...
  throws java.sql.SQLException
  {
      _conn = Connect();
	   if(_conn==null) return null;
     _query =   "  SELECT * FROM `$TABLENAME_photograph`  "+WhereClause+" "+OrderByClause+" LIMIT "+nLimit+" OFFSET "+nOffSet+" " ;
     _stmt = _conn.createStatement();
     _result  = _stmt.executeQuery(_query); 
     return _result ;
  } // end method openTable();
...
throws java.sql.SQLException 
{
 ...
 java.sql.Connection conn = Connect();
 if(conn==null) return 0;
 String query_count = "  SELECT COUNT(*) FROM `$TABLENAME_photograph`  "+WhereClause;
    try
    {
...
} /* End of class declaration for $CTABLENAME_photographBean */	
