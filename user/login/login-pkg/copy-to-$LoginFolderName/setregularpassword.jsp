...
<%@ page import="com.webapp.security.*" %>
...
{ 
	 ...
	 $BeanName.Password= request.getParameter("NewPassword1");
   $BeanName.PasswordType = PasswordType.USER ;
...
<br />
<button type="button" class="btn btn-raised btn-primary btn-lg center-block" onclick="NavigateTo('<%=appPath %>/$CTABLENAMELoginForm.jsp')" ><i class="fa fa-sign-in" aria-hidden="true"></i>&nbsp;Login with New Password</button>
<% 
}
else
{
